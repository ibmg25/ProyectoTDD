...
describe("Mostrar lista de katas", () => {
  ...
  it("deberia mostrar una lista con una kata", () => {
    ...
    const kataEsperada = "<div class='kata'><div class='title-kata'>Kata</div><div class='category-kata'>Ninguna</div><div class='difficulty-kata'>Media</div><div class='description-kata'>Descripcion vacia</div><div class='description-kata'>No Terminado</div></div>"
  ...
  it("deberia mostrar una lista con varias katas", () => {
    ...
    const listaEsperada ="<div class='kata'><div class='title-kata'>Kata</div><div class='category-kata'>Ninguna</div><div class='difficulty-kata'>Media</div><div class='description-kata'>Descripcion vacia</div><div class='description-kata'>No Terminado</div></div> <div class='kata'><div class='title-kata'>Kata</div><div class='category-kata'>Ninguna</div><div class='difficulty-kata'>Media</div><div class='description-kata'>Descripcion vacia</div><div class='description-kata'>No Terminado</div></div>"
...
describe("Filtrar katas por dificultad", () => {
  ...
  it("deberia mostrar una lista con katas de dificultad Facil", () => {
    ...
    const listaEsperada = "<div class='kata'><div class='title-kata'>Kata</div><div class='category-kata'>Ninguna</div><div class='difficulty-kata'>Facil</div><div class='description-kata'>Descripcion vacia</div><div class='description-kata'>No Terminado</div></div> <div class='kata'><div class='title-kata'>Kata</div><div class='category-kata'>Ninguna</div><div class='difficulty-kata'>Facil</div><div class='description-kata'>Descripcion vacia</div><div class='description-kata'>No Terminado</div></div>"
    expect(catalogo.printLista()).toEqual(listaEsperada);
  });
